...
function handleStorageRequest(req, res) {
...
export async function handleIcsRequest(req, res) {
    const url = req.url ?? '/';
    ...
    const contentType = upstreamResponse.headers.get('content-type') || 'text/calendar; charset=utf-8';
 ...
 */
export async function handleWebhookTaskRequest(req, res, url) {
